Pod::Spec.new do |s|
  ...
  s.public_header_files = 'SETOCryptomatorCryptor/Core/{SETOMasterKey,SETOMasterKeyFile,SETOCryptor,SETOAsyncCryptor}.h', 'SETOCryptomatorCryptor/Util/NSData+SETOBase64urlEncoding.h'
